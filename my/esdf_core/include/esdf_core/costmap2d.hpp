...
/**
 * @class esdf_core::Costmap2D
 * @brief Lightweight 2D occupancy costmap, independent of any ROS/Ceres dependency.
 *
 * Stores an occupancy grid as a flat unsigned char array in row-major order.
 * Provides the minimal interface required by the ESDF computation and capsule
 * footprint checks.
 */
class Costmap2D
{
...
#endif  // ESDF_CORE__COSTMAP2D_HPP_
