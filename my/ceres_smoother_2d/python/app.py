...
ESDF_SCHEME_DEFS = [
    {
        "key": "safety",
        "label": "Safety: red wall / green free",
        "vmin": -0.8,
        "vmax": 2.0,
        "stops": [
            (0.00, "#7f1d1d"),
        ...
        "swatch": "linear-gradient(to right,#7f1d1d,#ef4444,#fef08a,#86efac,#166534)",
    },
    {
        "key": "signed",
        "label": "Signed: blue negative / amber positive",
        "vmin": -1.5,
        "vmax": 2.0,
        "stops": [
            (0.00, "#172554"),
        ...
        "swatch": "linear-gradient(to right,#172554,#38bdf8,#fff,#facc15,#b45309)",
    },
    {
        "key": "terrain",
        "label": "Terrain: purple wall / cyan free",
        "vmin": -1.0,
        "vmax": 2.0,
        "stops": [
            (0.00, "#3b0764"),
        ...
        "swatch": "linear-gradient(to right,#3b0764,#c026d3,#fef3c7,#2dd4bf,#164e63)",
    },
    {
        "key": "mono",
        "label": "Mono: dark wall / light clearance",
        "vmin": -0.8,
        "vmax": 2.0,
        "stops": [
            (0.00, "#111827"),
        ...
        "swatch": "linear-gradient(to right,#111827,#ef4444,#f59e0b,#e0f2fe,#fff)",
    },
]
